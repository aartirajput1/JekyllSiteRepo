...
* [Installing and configuring an Owncloud server]({{site.baseurl }}/adding.md)
{% include_relative aa.md %}
* [Enabling users to connect to the Owncloud server using the server's IP address and port 8080](/about/)
* [Adding user accounts]
  <a href="JekyllSiteRepo/_pages/adding.html">Adding user accounts</a>
