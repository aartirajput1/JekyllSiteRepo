...
* [Installing and configuring an Owncloud server](https://aartirajput1.github.io/JekyllSiteRepo/adding/)
...
* [Connecting to the Owncloud server using desktop client](https://aartirajput1.github.io/JekyllSiteRepo/desktop)
